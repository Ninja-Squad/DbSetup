...
public class CommonOperations {
    public static final Operation DROP_TABLES =
        of(sql("drop table if exists A cascade"),
           sql("drop table if exists B cascade"));

    public static final Operation CREATE_TABLES =
        of(sql("create table A (a_id bigint primary key, va varchar(100), nu numeric(10, 2), bo boolean, da date, tis timestamp, tim time)"),
